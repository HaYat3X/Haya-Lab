...
export default {
    ...
    data() {
        return {
            ...
            images: [
                "/Haya-Lab/assets/my_closet/1.png",
                "/Haya-Lab/assets/my_closet/2.png",
                "/Haya-Lab/assets/my_closet/3.png",
                "/Haya-Lab/assets/my_closet/4.png",
                "/Haya-Lab/assets/my_closet/5.png",
                "/Haya-Lab/assets/my_closet/6.png",
                "/Haya-Lab/assets/my_closet/7.png",
            ],
            currentIndex: 0,
            interval: null,
        };
