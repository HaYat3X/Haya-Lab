                ...
                <div class="modal-body-original">
                    <div class="left-area">
                        <div class="service">
                            ...
                            <p class="links">
                                <a href="https://github.com/Hayate12345/News-app" target="_blank">
...
export default {
    ...
    data() {
        return {
            title: "Simple newS",
            explanation1: "ReactNativeを使用してニュースアプリを作成しました。 ニュースの記事はAPIから取得し、最新のニュースを20件表示するようにしています。 ニュースの記事を押すとニュース記事にアクセスできるように工夫しました。",
            ProductionScope: "制作期間：2日間",
            ScopeOfResponsibility: "担当範囲：プログラミング",
            TechnologyUsed: "HTML / CSS / ReactNative / JavaScript / Git / GitHub / Expo / API",
            images: [
                "/Haya-Lab/assets/news/1.png",
                "/Haya-Lab/assets/news/2.png",
            ],
            currentIndex: 0,
            interval: null,
        };
