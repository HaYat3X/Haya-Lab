                ...
                <div class="modal-body-original">
                    <div class="left-area">
                        <div class="service">
                            ...
                            <p class="links">
                                <a href="https://github.com/Hayate12345/travelogue-app" target="_blank">
...
export default {
    ...
    data() {
        return {
            title: "Travelogue",
            explanation1: "Ruby on Railsで作った旅行記録サイトです。 旅行記を投稿する際にはログインが必要ですが、閲覧するだけの場合はログインしなくても閲覧できるように工夫しました。 投稿機能以外にもいいね機能やタグ検索機能、フォロー機能など様々な機能を搭載しています。",
            ProductionScope: "制作期間：2週間",
            ScopeOfResponsibility: "担当範囲：プログラミング",
            TechnologyUsed: "HTML / CSS / Ruby / Ruby on Rails / SQlite / Bootstrap / Git / GitHub",
            images: [
                "/Haya-Lab/assets/travelogue/1.png",
                "/Haya-Lab/assets/travelogue/2.png",
                "/Haya-Lab/assets/travelogue/3.png",
                "/Haya-Lab/assets/travelogue/4.png",
            ],
            currentIndex: 0,
            interval: null,
        };
