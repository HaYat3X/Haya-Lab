                ...
                <div class="modal-body-original">
                    <div class="left-area">
                        <div class="service">
                            ...
                            <p class="links">
                                <a href="https://github.com/Hayate12345/Rails-Item-App" target="_blank">
...
export default {
    ...
    data() {
        return {
            ...
            explanation1: "Railsチュートリアルを参考にしながら、Railsを使用して作成したYouTubeクローンアプリです。 動画アップロード機能、動画視聴機能、動画検索機能が搭載されています。 Railsで動画をアップロードする処理を実装する際に苦戦しましたが、なんとか実装することができました。",
            ...
            images: [
                "/Haya-Lab/assets/youtube/1.png",
                "/Haya-Lab/assets/youtube/2.png",
                "/Haya-Lab/assets/youtube/3.png",
            ],
            currentIndex: 0,
            interval: null,
        };
