...
export default {
    ...
    data() {
        return {
            ...
            images: [
                "/Haya-Lab/assets/Real_intentioN/1.png",
                "/Haya-Lab/assets/Real_intentioN/2.png",
                "/Haya-Lab/assets/Real_intentioN/3.png",
                "/Haya-Lab/assets/Real_intentioN/4.png",
                "/Haya-Lab/assets/Real_intentioN/5.png",
            ],
            currentIndex: 0,
            interval: null,
        };
