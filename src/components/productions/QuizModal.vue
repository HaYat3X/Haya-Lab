                ...
                <div class="modal-body-original">
                    <div class="left-area">
                        <div class="service">
                            ...
                            <p class="links">
                                <a href="https://github.com/Hayate12345/pokemon-quiz" target="_blank">
...
export default {
    ...
    data() {
        return {
            title: "ポケモン Quiz",
            explanation1: "Angularを使用して作成したポケモンクイズアプリです。 JSON形式でポケモンを当てる問題と正解ポケモン、不正解ポケモンを用意してTypeScriptで問題の取得、選択肢を取得してHTMLで表示しています。 正解のポケモンを選択するとモーダルウィンドウで正解と表示しています。",
            ProductionScope: "制作期間：3日間",
            ScopeOfResponsibility: "担当範囲：プログラミング",
            TechnologyUsed: "HTML / SCSS / CSS / Angular / JavaScript / TypeScript / Git / GitHub / JSON",
            images: [
                "/Haya-Lab/assets/quiz/1.png",
                "/Haya-Lab/assets/quiz/2.png",
                "/Haya-Lab/assets/quiz/3.png",
            ],
            currentIndex: 0,
            interval: null,
        };
